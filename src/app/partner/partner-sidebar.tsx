...
const navItems = [
  { href: "/partner", icon: LayoutDashboard, label: "대시보드" },
  { href: "/partner/orders", icon: Truck, label: "주문/배송 관리" },
];
    ...
    <div className="flex min-h-screen">
      ...
      >
        <div className="flex h-16 items-center justify-between px-6 border-b border-gray-700">
          <Link href="/partner" className="text-xl font-bold text-white">
            <span className="logo-text">YeAmall</span>{" "}
            <span className="text-sm font-normal text-gray-400">Partner</span>
          </Link>
          <button
